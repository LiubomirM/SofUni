String.prototype.startsWith = function(substring) {
    var subStr = this.substring(0, substring.length);
    return subStr === substring;
}

String.prototype.endWith = function(substring) {
    var subStr = this.substring(this.length - substring.length, this.length);
    return subStr === substring;
}

String.prototype.left = function(count) {
    var subStr = this.substring(0, count);
    return subStr;
}

String.prototype.right = function(count) {
    var subStr = this.substring(this.length - count, this.length);
    return subStr;
}
